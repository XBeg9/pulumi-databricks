...
class AwsS3Mount(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, cluster_id=None, mount_name=None, s3_bucket_name=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        super(AwsS3Mount, __self__).__init__(
            'databricks:aws/awsS3Mount:AwsS3Mount',
            resource_name,
            __props__,
            opts)

    @staticmethod
    def get(resource_name, id, opts=None, cluster_id=None, mount_name=None, s3_bucket_name=None):
        """
