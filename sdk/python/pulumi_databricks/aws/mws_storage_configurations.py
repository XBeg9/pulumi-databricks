...
class MwsStorageConfigurations(pulumi.CustomResource):
    ...
    storage_configuration_name: pulumi.Output[str]
    def __init__(__self__, resource_name, opts=None, account_id=None, bucket_name=None, storage_configuration_name=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['storage_configuration_name'] = storage_configuration_name
            __props__['creation_time'] = None
            __props__['storage_configuration_id'] = None
        super(MwsStorageConfigurations, __self__).__init__(
            'databricks:aws/mwsStorageConfigurations:MwsStorageConfigurations',
            resource_name,
            __props__,
            opts)

    @staticmethod
    def get(resource_name, id, opts=None, account_id=None, bucket_name=None, creation_time=None, storage_configuration_id=None, storage_configuration_name=None):
        """
