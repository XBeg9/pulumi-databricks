...
class InstanceProfile(pulumi.CustomResource):
    ...
    skip_validation: pulumi.Output[bool]
    def __init__(__self__, resource_name, opts=None, instance_profile_arn=None, skip_validation=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            if skip_validation is None:
                raise TypeError("Missing required property 'skip_validation'")
    ...
    @staticmethod
    def get(resource_name, id, opts=None, instance_profile_arn=None, skip_validation=None):
        """
