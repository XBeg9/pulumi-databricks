...
class SecretScope(pulumi.CustomResource):
    backend_type: pulumi.Output[str]
    initial_manage_principal: pulumi.Output[str]
    name: pulumi.Output[str]
    def __init__(__self__, resource_name, opts=None, initial_manage_principal=None, name=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['initial_manage_principal'] = initial_manage_principal
            __props__['name'] = name
    ...
    @staticmethod
    def get(resource_name, id, opts=None, backend_type=None, initial_manage_principal=None, name=None):
        """
