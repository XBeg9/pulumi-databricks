...
class SecretAcl(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, permission=None, principal=None, scope=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, permission=None, principal=None, scope=None):
        """
