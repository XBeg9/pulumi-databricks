...
class AzureBlobMount(pulumi.CustomResource):
    ...
    token_secret_key: pulumi.Output[str]
    token_secret_scope: pulumi.Output[str]
    def __init__(__self__, resource_name, opts=None, auth_type=None, cluster_id=None, container_name=None, directory=None, mount_name=None, storage_account_name=None, token_secret_key=None, token_secret_scope=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['token_secret_key'] = token_secret_key
            if token_secret_scope is None:
                raise TypeError("Missing required property 'token_secret_scope'")
            __props__['token_secret_scope'] = token_secret_scope
        super(AzureBlobMount, __self__).__init__(
            'databricks:azure/azureBlobMount:AzureBlobMount',
            resource_name,
            __props__,
            opts)

    @staticmethod
    def get(resource_name, id, opts=None, auth_type=None, cluster_id=None, container_name=None, directory=None, mount_name=None, storage_account_name=None, token_secret_key=None, token_secret_scope=None):
        """
