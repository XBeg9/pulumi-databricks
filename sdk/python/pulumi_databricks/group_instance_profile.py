...
class GroupInstanceProfile(pulumi.CustomResource):
    ...
    instance_profile_id: pulumi.Output[str]
    def __init__(__self__, resource_name, opts=None, group_id=None, instance_profile_id=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            __props__['instance_profile_id'] = instance_profile_id
    ...
    @staticmethod
    def get(resource_name, id, opts=None, group_id=None, instance_profile_id=None):
        """
