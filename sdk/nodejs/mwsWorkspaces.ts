...
export class MwsWorkspaces extends pulumi.CustomResource {
    ...
    public /*out*/ readonly networkErrorMessages!: pulumi.Output<outputs.MwsWorkspacesNetworkErrorMessage[]>;
...
export interface MwsWorkspacesState {
    ...
    readonly networkErrorMessages?: pulumi.Input<pulumi.Input<inputs.MwsWorkspacesNetworkErrorMessage>[]>;
