...
export class Secret extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: SecretArgs | SecretState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts && opts.id) {
            ...
            inputs["lastUpdatedTimestamp"] = state ? state.lastUpdatedTimestamp : undefined;
            inputs["scope"] = state ? state.scope : undefined;
            inputs["stringValue"] = state ? state.stringValue : undefined;
        } else {
            ...
            if (!args || args.stringValue === undefined) {
                throw new Error("Missing required property 'stringValue'");
            }
            inputs["key"] = args ? args.key : undefined;
            inputs["scope"] = args ? args.scope : undefined;
            inputs["stringValue"] = args ? args.stringValue : undefined;
            inputs["lastUpdatedTimestamp"] = undefined /*out*/;
        }
        if (!opts) {
            opts = {}
        }
...
export interface SecretState {
    ...
    readonly lastUpdatedTimestamp?: pulumi.Input<number>;
    readonly scope?: pulumi.Input<string>;
    readonly stringValue?: pulumi.Input<string>;
}
