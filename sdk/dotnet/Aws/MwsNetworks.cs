...
namespace Pulumi.Databricks.Aws
{
    public partial class MwsNetworks : Pulumi.CustomResource
    {
        ...
        public MwsNetworks(string name, MwsNetworksArgs args, CustomResourceOptions? options = null)
            : base("databricks:aws/mwsNetworks:MwsNetworks", name, args ?? new MwsNetworksArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MwsNetworks(string name, Input<string> id, MwsNetworksState? state = null, CustomResourceOptions? options = null)
            : base("databricks:aws/mwsNetworks:MwsNetworks", name, state, MakeResourceOptions(options, id))
        {
        }
