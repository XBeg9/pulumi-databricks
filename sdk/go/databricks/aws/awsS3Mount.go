...
func NewAwsS3Mount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("databricks:aws/awsS3Mount:AwsS3Mount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAwsS3Mount(ctx *pulumi.Context,
	...
	var resource AwsS3Mount
	err := ctx.ReadResource("databricks:aws/awsS3Mount:AwsS3Mount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
