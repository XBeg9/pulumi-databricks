...
func NewMwsNetworks(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("databricks:aws/mwsNetworks:MwsNetworks", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMwsNetworks(ctx *pulumi.Context,
	...
	var resource MwsNetworks
	err := ctx.ReadResource("databricks:aws/mwsNetworks:MwsNetworks", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
