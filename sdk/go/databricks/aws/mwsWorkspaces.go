...
func NewMwsWorkspaces(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("databricks:aws/mwsWorkspaces:MwsWorkspaces", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMwsWorkspaces(ctx *pulumi.Context,
	...
	var resource MwsWorkspaces
	err := ctx.ReadResource("databricks:aws/mwsWorkspaces:MwsWorkspaces", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
