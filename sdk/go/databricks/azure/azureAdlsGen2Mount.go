...
func NewAzureAdlsGen2Mount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("databricks:azure/azureAdlsGen2Mount:AzureAdlsGen2Mount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureAdlsGen2Mount(ctx *pulumi.Context,
	...
	var resource AzureAdlsGen2Mount
	err := ctx.ReadResource("databricks:azure/azureAdlsGen2Mount:AzureAdlsGen2Mount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
